    ...
    protected Parcelable onSaveInstanceState(){
        ...
        for(int i = 0;i < getChildCount();i++)
        {
            ...
            if(id != 0)
            {
                ...
                childrenStates.putSparseParcelableArray
                        (String.valueOf(id), childrenState);
            }
        }
        ...
        for(int i = 0;i < getChildCount();i++)
        {
            ...
            if(id != 0){
                if(childrenStates.containsKey(String.valueOf(id))){
                    SparseArray childrenState = childrenStates
                            .getSparseParcelableArray(String.valueOf(id));
